...
function Certificates({isC})
{
  ...
  return(
    <div className="Certificates" style={{position:'relative'}}>
      ...
      {selectedImage&&
      <div style={{display:'flex',flexDirection:'column',height:'550px',width:'720px', backgroundColor:'gray', position:'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', borderRadius:'10px', zIndex:1000}}>
