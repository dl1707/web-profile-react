 ...
 ({
  ...
  return(
    <div style={{display:'flex',border:'1px solid blue',borderRadius:8}}>
      ...
      <button style={{border:'none',borderRadius:'100px',padding:15,marginBottom:1,marginTop:1,marginLeft:0.5,width:50,height:50,display:'flex',alignItems:'center',justifyContent:'center'}} onClick={chmod}><img src={"./Icons/Moon UI.png"} alt="B/B Mode" style={{borderRadius:'70px',width:20}}/></button>
    </div>
  );
}
